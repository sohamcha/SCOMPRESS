...
int _tmain(int argc, _TCHAR* argv[])
{
   ...
   cout<<"***** SCOMPRESS - the General Purpose Compression Tool ( V 0.2 Alpha DATED : 7/15/2011 Compiled in VC++ 2010 / .NEt 4 ) ***** \n\n - Soham Chakraborty \n\n";
   ...
   if(choice==1)
   {
      ...
      // size = i-1;     //  NEW ACTUAL STRING SIZE
        ...
        cout<<endl<<"COMPLETED Creating REDUNDANT DATA FILE.\n\nProceeding to Create COMPRESSED FILE ";    
        system("PAUSE");
        close(&file,&file2);
